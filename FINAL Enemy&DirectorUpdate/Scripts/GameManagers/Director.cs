...
public class Director : MonoBehaviour
{
    ...
    private int max_enemy_count = 3;
    private int[] max_enemy_counts = { 3, 2, 1 };
    ...
    {
        if (GetEnemyCount() < max_enemy_count && enemy_parents[indx].childCount < max_enemy_counts[indx])
        {
    ...
    private int GetEnemyCount()
    {
        ...
        foreach (Transform enemy_parent in enemy_parents)
        {
            enemy_count += enemy_parent.childCount;
        }
