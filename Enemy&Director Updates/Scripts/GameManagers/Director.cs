...
public class Director : MonoBehaviour
{
    ...
    public float powerup_spawn_cooldown = 8f;
    ...
    private int max_meteor_spawn_count = 10;
    ...
    {
        currency += currency_increment_rate * (Time.time * time_multiplier) * Time.deltaTime;
    }
    ...
    private void SpawnEnemy(int indx)
    {
        ...
        GameObject enemy = Instantiate(enemy_prefabs[indx], random_location, enemy_prefabs[indx].transform.rotation);
